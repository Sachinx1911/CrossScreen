...
/**
 * docs/ui-scope-mobile.md §4 / design/mobile spec §6: the system font
 * (Roboto on Android) rather than a bundled one — the spec's own rule 5
 * ("Android uses Material 3 patterns") and its warning against "too many
 * font sizes" both point the same way. `FontFamily.Default` picks up the
 * platform font without a custom `FontFamily`.
 */
val CrossScreenTypography = Typography(
