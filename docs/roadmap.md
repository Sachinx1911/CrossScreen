...
2. **Only Windows is validated in Phase 1.** The Electron code is written once
   ...
   Linux stay marked *untested* until Phase 3b. This is a testing-scope
...
| **0.5** | **Walking skeleton — GO/NO-GO GATE.** Hardcoded session, zero UI, no DB: Electron on Windows captures a screen → WSS signaling → Chrome on a *different network* renders it live | 1–2 wk | — |
