...
| **[2](phases/phase-2-reliability.md)**          | Reliability: Cloudflare TURN, forced-relay test mode, ICE restart, Wi-Fi↔mobile reconnection, sleep/wake, stats, Sentry                                                          | 4–5 wk   | 🔨 in progress                            |
